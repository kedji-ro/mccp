...
if (isset($_POST["EMAIL_ADD"]) && isset($_POST["OTP_CODE"])){
    	
            $NAME = 'Mother and Child Care';
            $EMAIL_RECV = $_POST['EMAIL_ADD'];
            $MAIL_BODY = "Your OTP Code Generated:" . $_POST["OTP_CODE"];
            $TITLE = 'Mother and Child Care - OTP Code';
        	...
        	$mail->Port       = 25;                    
        	$mail->Host       = "localhost"; 
        	$mail->Username   = "donot-reply-otp@motherchildcareportal.com";   
        	$mail->Password   = "2C.hNSw:E!6qepV";            
        
        	$mail->IsSendmail();  
        
        	$mail->From       = 'donot-reply-otp@motherchildcareportal.com';
        	$mail->FromName   = $NAME;
        
        	$mail->AddAddress($EMAIL_RECV);
            $mail->Subject  = $TITLE;
        	$mail->WordWrap   = 80; 
