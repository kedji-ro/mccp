...
<head>
  ...
  <title>Mother Child Care Portal</title>
  ...
  <!-- Vendor CSS Files -->
  <link href="assets/home/vendor/fontawesome-free/css/all.min.css" rel="stylesheet">
...
<body>
  ...
  <div id="topbar" class="d-flex align-items-center fixed-top">
    <div class="container d-flex justify-content-between">
      <div class="contact-info d-flex align-items-center">
        <i class="bi bi-envelope"></i> <a href="mailto:contact@example.com">support@motherchildcareportal.com</a>
        <i class="bi bi-phone"></i> +1 2345 67891 00
      </div>
    </div>
  </div>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.html">Mother Child Care Portal</a></h1>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container">
      <h1>Welcome to <br>Mother Child Care Portal</h1>
      <!-- <h2>Tagline here</h2> -->
  ...
  <main id="main">
        ...
        <div class="row">
          <div class="col-lg-3 d-flex align-items-stretch">
            <div class="content">
              <h3>Quick Guide</h3>
              <p>
                Follow this quick guide to learn how to set and organize your own appointments.
              </p>
    ...
    <section id="services" class="services">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Services</h2>
          <p>Mother Child Care Portal offers the following services to help patients and doctors reach each other easily.</p>
        </div>
    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Contact</h2>
          <p>You can reach us through these channels.</p>
        </div>
          ...
          <div class="row mt-5">
            <div class="col-lg-4">
              <div class="info address">
                ...
                <h4>Location:</h4>
                <p>123 Dummy Street, Dummy City, Country 9500</p>
              </div>
            </div>
            ...
            <div class="col-lg-4">
              <div class="info email">
                ...
                <h4>Email:</h4>
                <p>support@motherchildcareportal.com</p>
              </div>
            </div>
