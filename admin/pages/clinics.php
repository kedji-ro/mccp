                        ...
                        <tr>
                            ...
                            <td class="text-center"><button type="button" class="btn btn-primary btn-circle btn-sm editClinic" title="View/Edit Details"><i class="fa fa-edit"></i></button>
                                ...
                                <?php } else { ?>
                                    ...
                                    <span><button type="button" class="btn btn-secondary btn-circle btn-sm archiveClinicBtn" title="Archive"><i class="fa fa-archive"></i></button></span>
                                <?php } ?>
                            </td>
                        </tr>
                <?php
...
<script>
    $(document).ready(function() {
        ...
        $('.archiveClinicBtn').on('click', function() {
            ...
            $('#c_deactReactTitle').html('Archive');
            $('#c_op').html('Archive');
            $('#c_drid').val(data[0]);
            $('#c_drname').html(data[1]);
            $('#c_stat').val($.trim(data[5]));
