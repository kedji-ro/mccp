                        ...
                        <div class="row mt-3">
                            <div class="col-sm-12">
                                ...
                                <div id="" class="d-sm-flex align-items-center justify-content-between">
                                    <a class="btn btn-light btn-circle" onclick="markActive('rSu','0');">Su</a>
                                    <a class="btn btn-light btn-circle" onclick="markActive('rMo','1');">Mo</a>
                                    <a class="btn btn-light btn-circle" onclick="markActive('rTu','2');">Tu</a>
                                    <a class="btn btn-light btn-circle" onclick="markActive('rWe','3');">We</a>
                                    <a class="btn btn-light btn-circle" onclick="markActive('rTh','4');">Th</a>
                                    <a class="btn btn-light btn-circle" onclick="markActive('rFr','5');">Fr</a>
                                    <a class="btn btn-light btn-circle" onclick="markActive('rSa','6');">Sa</a>
                                </div>
                ...
                <div class="modal-body">
                    <div class="container">
                        ...
                        <div class="col-sm-12">
                                <label for="">Repeat</label><br>
                                <div id="" class="d-sm-flex align-items-center justify-content-between">
                                    <a class="btn btn-light btn-circle" onclick="markActive('rSu','0');" id="rSu">Su</a>
                                    <a class="btn btn-light btn-circle" onclick="markActive('rMo','1');" id="rMo">Mo</a>
                                    <a class="btn btn-light btn-circle" onclick="markActive('rTu','2');" id="rTu">Tu</a>
                                    <a class="btn btn-light btn-circle" onclick="markActive('rWe','3');" id="rWe">We</a>
                                    <a class="btn btn-light btn-circle" onclick="markActive('rTh','4');" id="rTh">Th</a>
                                    <a class="btn btn-light btn-circle" onclick="markActive('rFr','5');" id="rFr">Fr</a>
                                    <a class="btn btn-light btn-circle" onclick="markActive('rSa','6');" id="rSa">Sa</a>
                                </div>
...
<script>
    ...
    function markActive(id, no) {
        var el = document.getElementById(id);
        var d = document.getElementById('sdays');

        if (el.classList.contains('active')) {
            console.log('F');
            el.removeAttribute('class');
            el.setAttribute('class','btn btn-primary btn-circle active');
            // $('#' + id + '').removeClass('btn btn-primary btn-circle active');
            // $('#' + id + '').addClass('btn btn-primary btn-circle');
            
            var rVal = document.getElementById('sdays').value;
            $('#sdays').val(rVal.replace(','+no+'',''));
        } else {
            console.log('G');
