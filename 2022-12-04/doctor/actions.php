...
if (isset($_POST['complete_appointment'])) {
    ...
    $q = "UPDATE tb_appointment SET a_stat = '4' WHERE appointment_id = '" . $a_id . "'";
...
if (isset($_POST['add_schedule'])) {
    ...
    $q = "INSERT INTO tb_doctor_schedule (doctor_id, clinic_id, date_available, start_time, end_time, bg_color, s_stat, slots)
                        VALUES ('".$d_id."','".$clinic."','".$date."','".$start."','".$end."','".$color."','1','".$slots."')";
